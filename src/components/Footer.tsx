    ...
    <footer className="bg-white py-10 border-t mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Bundles</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Merch</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t pt-6 flex flex-col md:flex-row items-center justify-between text-sm">
          <div className="text-gray-500 mb-4 md:mb-0">© 2025 HYDRATE. All rights reserved.</div>
